...
import 'package:coffee_paws_app_api/src/api_util.dart';
...
class CoffeePawsApi {
  ...
  const CoffeePawsApi(this._dio, this._serializers);
  ...
  Future<Response<Store>> createStore({ 
    required CreateStore createStore,
    ...
    final _path = r'/coffee-paws/stores';
    ...
    try {
      const _type = FullType(CreateStore);
      _bodyData = _serializers.serialize(createStore, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<PlaceType>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<PlaceType>>> getPlaceTypes({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/coffee-paws/places/types';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<PlaceType>? _responseData;
    ...
    return Response<BuiltList<PlaceType>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Store>>> getStores({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<User>> getUser({ 
    ...
    final _path = r'/coffee-paws/users/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<User>>> getUsers({ 
    ...
    final _path = r'/coffee-paws/users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlacesSearchResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PlacesSearchResponse>> searchNearby({ 
    ...
    final _path = r'/coffee-paws/places/nearby';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (placeType != null) r'placeType': encodeQueryParameter(_serializers, placeType, const FullType(String)),
    ...
    PlacesSearchResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlacesSearchResponse),
    ...
    return Response<PlacesSearchResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
